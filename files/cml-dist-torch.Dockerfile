...
ENV ML_RUNTIME_EDITION="Distributed PyTorch" \
 ML_RUNTIME_SHORT_VERSION="1.0" \
 ML_RUNTIME_MAINTENANCE_VERSION="1"
ENV ML_RUNTIME_FULL_VERSION="$ML_RUNTIME_SHORT_VERSION.$ML_RUNTIME_MAINTENANCE_VERSION" ML_RUNTIME_DESCRIPTION="This runtime includes the package required to run distrubted model training for PyTorch 1.8.1"
